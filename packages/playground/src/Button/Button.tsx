...
type ButtonClassNames = typeof classNames;

export const Button: Component<ButtonProps, ButtonClassNames> = () => (
  <button type="button">Hello</button>
);

Button.classNames = classNames;
Button.classNames('small', 'outline');
Button.classNames.icon();
Button.classNames.trailingIcon();
